...
let me = {
    name: "David",
    myPhoto: "images/davidPhoto.png",
    hobbies: ["Jiu Jitsu", "Boxing", "Climbing", "Ride Horses", "Cook"],
    favoriteFoods: ["Churrasco", "Corn", "Corn Cake", "Feijão Tropeiro"],
    placesLived: [],
  };
  
  me.placesLived.push({ place: "Recife", time: "23 years" });
  me.placesLived.push({ place: "São Paulo", time: "4 years" });
...
nameElement.innerHTML = me.name;

let photoElement = document.getElementById("photo");
photoElement.setAttribute("src", me.myPhoto);
...
me.placesLived.forEach(function (place) {
  ...
  dd.textContent = place.time + " years";
